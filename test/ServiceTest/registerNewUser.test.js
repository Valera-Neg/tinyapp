...
describe('#createUser()', () => {
  it ("createUser() should create a new user", () =>{
    let newUser = mockService.registerNewUser("frances.lebsack89@gmail.com", 'test123');
  ...
  it (" registerNewUser() should return a user object, but parameters are invalid", () =>{
    expect(function(){
      mockService.registerNewUser("ppppppp");
    }).to.throw()
  })
  it (" registerNewUser() should return a user object, but email is not unique", () =>{
    expect(function(){
      mockService.registerNewUser("clarissa15@yahoo.com", "testTest");
    }).to.throw()
  })
});