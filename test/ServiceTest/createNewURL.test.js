...
describe('#createNewURL()', () => {
  it ("createNewURL() should create URL record", () =>{
    let newURL = mockService.createNewURL('https://gmail.com', 'qnyo09');
  ...
  it ("createNewURL() should attempt to create URL record, and fail", () =>{
    expect(function(){
      mockService.createNewURL('https://gmail.com', '');
    }).to.throw()
  })
});